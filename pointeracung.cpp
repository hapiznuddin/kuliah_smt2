...
void tambahData(){
    ...
    {   
        cout << "-------------------------------------------------\n";
        cout << " Data " << (i + 1) << endl;
        cout << "Masukan No.ID              = "; cin >> (*dataptr).ktp[i].noID; cin.ignore(5, '\n');
        cout << "Masukan Nama               = "; cin.getline((*dataptr).ktp[i].nama, 30);
...
void editData(){
    ...
    cout << " Pilih Data yang ingin diubah = "; cin >> *dataNumberPtr;
    *dataNumberPtr -= 1;
    cout << "-------------------------------------------------\n";
    cout << " Data " << (*dataNumberPtr + 1) << endl;
    cout << "Masukan No.ID              = "; cin >> (*dataptr).ktp[*dataNumberPtr].noID; cin.ignore(5, '\n');
    cout << "Masukan Nama               = "; cin.getline((*dataptr).ktp[*dataNumberPtr].nama, 30);
